...
//https://github.com/lcdwiki/LCDWIKI_kbv/blob/master/Document/LCDWIKI%20KBV%20lib%20Requirements.pdf
...
unsigned long show_text(void)
{
    ...
    my_lcd.Print_String("This is Aniruddh Chauhans Desk", CENTER, 1);
    ...
    my_lcd.Print_String("...kinda...", CENTER, my_lcd.Get_Display_Height()-11);
